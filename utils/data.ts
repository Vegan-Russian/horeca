...
export const articles: Article[] = [
  ...
  },
  {
    id: 'zakuski',
    description:
      'Вы узнаете больше о таких ингредиентах в блюдах, как оливки, маслины, хрустящие баклажаны и хумус. Вяленые томаты.',
    name: 'Закуски',
    content: zakuski,
    images: {
  ...
  },
  {
    id: 'zavtraki',
    description:
      'Вы узнаете больше об особенностях в таких блюдах, как арахисовая паста, готовые сухие завтраки, каша быстрого приготовления, тостовый хлеб.',
    name: 'Завтраки',
    content: zavtraki,
    images: {
  ...
  },
  {
    ...
    name: 'Десерты',
    description:
      'Вы узнаете о таких ингредиентах, продуктах и блюдах, как батончики, джем, сиропы и топпинги, сыроедческие десерты (RAW), чиа-пуддинг.',
    content: deserty,
    images: {
  ...
  },
  {
    ...
    name: 'Соусы',
    description:
      'Вы узнаете о соусах: бальзамический уксус, барбекю (BBQ) соус, горчица, горчичный соус, гуакамоле, кетчуп, томатный соус, карри соус, кимчи соус, майонез, ореховый соус (гомадаре), песто, понзу, ремулад, сифудо, соевый соус, спайси соус, тахини (кунжутный соус), терияки, унаги, хрен, шрирача.',
    content: sousy,
    images: {
