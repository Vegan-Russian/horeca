  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: 'text',
        content:
          'Сухари Панко используют для панировки роллов или других блюд паназиатской кухни.',
      },
      {
        type: 'subtitle',
        content: 'Однозначно невеганские ингредиенты:',
      },
      {
        type: 'text',
        content:
            'Куриные яйца. Обычно содержатся не в самих сухарях панко, а в кляре.',
      },
      {
        type: 'subtitle',
        content: 'Нужно проверить:',
      },
      {
        type: 'text',
        content:
            'Эфиры глицерина или глицеридов (е472a-472g). Группа эмульгаторов, которые могут получать из животных  жиров или растительного масла. Нужна проверка через производителей.',
      },
      {
        type: 'subtitle',
        content: 'Совет:',
      },
      {
        type: 'text',
        content:
          'См. <a href="https://www.veganhoreca.ru/term?search=%D0%9A%D0%BB%D1%8F%D1%80" target="_blank">Кляр</a>, чтобы узнать, как сделать веганский кляр без яиц.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        type: 'text',
        content:
            'Панировку используют для котлет и луковых колечек. Мы поможем вам выбрать веганские панировочные сухари.',
      },
      {
        type: 'subtitle',
        content: 'Однозначно невеганские ингредиенты:',
      },
      {
        ...
        content: [
          'Коровье молоко.',
          'Куриное яйцо. Обычно это компонент <a href="https://www.veganhoreca.ru/term?search=%D0%9A%D0%BB%D1%8F%D1%80" target="_blank">кляра</a>. Но также яйцо может быть в составе самой панировки. Лучше всего будет проверить, чтобы его не было ни там, ни там.'
        ],
      },
      {
        type: 'subtitle',
      ...
      },
      {
        type: 'list',
        content: [
          'Красители. Кармин (е120) делают из жуков, Бета-каротин (е160а) может содержать желатин, а Рибофлавин (е101) могут получать из молока и яиц. Если название или номер красителя не указаны на пачке, нужно уточнить их у производителя. В проверке добавок может помочь наш <a href="https://t.me/veganeshkibot" target="_blank">бот</a>.',
      ...
      },
      {
        type: 'text',
        content:
            'Чаще всего панировку делают из хлеба с коротким составом, котором нет молока. Выбирайте самую простую панировку.',
      },
    ],
  },
  {
