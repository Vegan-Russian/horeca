...
const vypechka: ArticleContent[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'subtitle', content: 'Однозначно невеганские ингредиенты:' },
      {
        type: 'list',
        content: [
          'Шеллак (е904). Глазирователь, получаемый из жуков.',
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'subtitle', content: 'С вниманием:' },
      {
        type: 'text',
        content:
          'Некоторую выпечку и хлеб смазывают яичным белком для блеска. Веганам такой хлеб не подходит.',
      },
      { type: 'subtitle', content: 'Нужно проверить:' },
      {
        ...
        content: [
          ...
          '<a href="https://veganrussian.ru/e304/" target="blank">Аскорбилпальмитат (е304)</a>. Эмульгатор.',
          '<a href="https://veganrussian.ru/e322/" target="blank">Лецитин (е322)</a>. Эмульгатор.',
          '<a href="https://veganrussian.ru/e481/" target="blank">Стеароил-2-лактилат натрия (е481)</a>. Эмульгатор.',
          '<a href="https://veganrussian.ru/e920/" target="blank">L-цистеин (e920)</a>.  Считается, что его всегда получают из перьев, но есть и другой способ. Ферментация глюкозы вытесняет способ из перьев.',
    ...
    content: [
      ...
      { type: 'subtitle', content: 'Нужно проверить:' },
      {
        ...
        content: [
          ...
          'Эмульгаторы. Возьмите за правило искать непонятные ингредиенты, так вы переведете их в разряд ешек. А Е-номера можно проверить на <a href="https://veganrussian.ru" target="blank">veganrussian.ru</a> или в приложениях VegSafe/Vegan Additives. Можете использовать нашего <a href="https://t.me/veganeshkibot" target="blank">бота</a>',
  ...
  },
  {
    type: 'block',
    content: [
      { type: 'title', content: 'Бао булочки (тесто)' },
      { type: 'subtitle', content: 'Однозначно невеганские ингредиенты:' },
